...
export default function Shell({
  ...
  return (
    <>
      ...
      >
        <div
          className="w-[min(86vw,560px)] overflow-hidden rounded-sm bg-white text-black shadow-2xl"
        ...
        >
          ...
          <div
            className="max-h-[70vh] overflow-y-auto bg-white px-3 pb-4 pt-3"
            style={{ backgroundColor: "#ffffff", opacity: 1 }}
          >
            <div className="mb-4">
              ...
              {recentViewedProducts.length === 0 ? (
                ...
                <div className="grid grid-cols-2 gap-x-2 gap-y-3 sm:grid-cols-5">
